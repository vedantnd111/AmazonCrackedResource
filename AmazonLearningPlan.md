...
| ------ | ------ | ------ |
| [Number of Islands](https://leetcode.com/problems/number-of-islands/)  | ❌ | has to learn graph |
| [Partition Labels](https://leetcode.com/problems/partition-labels/) | ✅ | Medium-seen |
| [Two Sum](https://leetcode.com/problems/two-sum/) | ✅ | Medium |
| [Reorder Data in Log Files](https://leetcode.com/problems/reorder-data-in-log-files/)  | ✅ | Meduim-seen |
| [LRU Cache](https://leetcode.com/problems/lru-cache/)  |  ✅  | Medium-seen  |
| [Minimum Difficulty of a Job Schedule](https://leetcode.com/problems/minimum-difficulty-of-a-job-schedule/)  | ❌ | has to learn dp |
| [Critical Connections in a Network](https://leetcode.com/problems/critical-connections-in-a-network/) | ❌ | has to learn graph |
| [Pairs of Songs With Total Durations Divisible by 60](https://leetcode.com/problems/pairs-of-songs-with-total-durations-divisible-by-60/)  | ✅ | Easy-seem |
...
| [Trapping Rain Water]( https://leetcode.com/problems/trapping-rain-water/)| ✅  | Easy |
| [Word Ladder]( https://leetcode.com/problems/word-ladder/)  |  |  |
|  [Maximal Square]( https://leetcode.com/problems/maximal-square/)  | ✅ | Hard-seen on lc course |
...
| Problem Link | Status | Difficulty |
| ------ | ------ | ------ |
| [Longest Substring Without Repeating Characters]( https://leetcode.com/problems/longest-substring-without-repeating-characters/)  | ✅ | Medium-seen |
...
| [Prison Cells After N Days]( https://leetcode.com/problems/prison-cells-after-n-days/)  | ✅ | Medium-seen |
| [Meeting Rooms II]( https://leetcode.com/problems/meeting-rooms-ii/) | ❌ | NA |
| [Group Anagrams]( https://leetcode.com/problems/group-anagrams/) | ✅ | Easy |
| [Sliding Window Maximum]( https://leetcode.com/problems/sliding-window-maximum/)  | ✅ | Medium-seen |
